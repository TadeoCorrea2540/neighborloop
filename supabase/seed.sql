-- ============================================================
-- seed.sql · Stable, safe taxonomy only
-- Run automatically by `supabase db reset` / `supabase start`, or apply
-- manually. Idempotent via ON CONFLICT. NO fake users/orgs/missions here.
-- ============================================================
